...
\begin{tikzpicture}[scale=0.85]
    ...
    \draw[-{Stealth[length=2mm]}, thick, orange!90!black] (1.8,0) -- (1.8, 0.9) node[above, align=left, font=\scriptsize] {\textbf{Rung 3: Heading Drift}\\Drifts $3.0\text{m}$ at Step 70};
\end{tikzpicture}
}
