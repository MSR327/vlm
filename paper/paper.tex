...
\subsubsection{The Information Bottleneck Sweet Spot ($d_z = 95$)}
...
\subsubsection{Latent Space Scaling ($d_z = 95 \to 190$): The Invariance of Effective Rank}
...
These empirical observations motivate the investigation of patch-based tokenization and cross-attention transformer architectures~\cite{transfuser2021, interfuser2022, vaswani2017attention} as a potential solution to these limitations:
\begin{itemize}
