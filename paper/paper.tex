...
\begin{tabular}{lcccc}
\toprule
\textbf{Empirical Metric} & \textbf{Rung 1 (Monocular)} & \textbf{Rung 2a (4-Cam Surround)} & \textbf{Rung 2b (Pruned 3-Cam)} & \textbf{Rung 3 (Cam + LiDAR BEV)} \\
\midrule
...
\textbf{Actor Policy Parameters} & 326,102 & 468,602 & 421,102 & 373,602 \\
\textbf{Critic Policy Parameters} & 326,001 & 426,001 & 426,001 & 326,001 \\
\textbf{Total Model Parameters} & \textbf{14,401,765} & \textbf{14,544,265} & \textbf{14,500,265} & \textbf{28,198,927} \\
...
\midrule
\textbf{Town01 Training Timesteps} & $\sim 105,000$ & $\sim 63,000$ & $\sim 12,205$ & Active / In Progress \\
\textbf{Town01 Route Completion} & \textbf{39.0\% ($195\text{ m}$)} & \textbf{3.4\% ($17\text{ m}$)} & \textbf{25.0\% ($125\text{ m}$)} & Converging \\
\textbf{Town01 Mean Reward ($R$)} & \textbf{313.21} & \textbf{17.35} & \textbf{158.31} & Converging \\
...
\textbf{Primary Failure Cause} & Turn Blindness (Meter 190) & Straight-Line Trap / Optic Flow & DirectX Buffer Overrun & Sparse BEV NaN (Diagnosed \& Fixed) \\
\bottomrule
\end{tabular}
}
\end{table*}
